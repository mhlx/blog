...
public class TemplateController {
    ...
    @GetMapping("templateHelperSourceCode")
    public String getTemplateHelperSourceCode() {
        return templateService.getTemplateHelperSourceCode();
    }

    @PutMapping("templateHelperSourceCode")
    public ResponseEntity<?> update(@NotBlank(message = "源码不能为空") @RequestBody String sourceCode) {
        templateService.updateTemplateHelperSourceCode(sourceCode);
        return ResponseEntity.noContent().build();
    }
